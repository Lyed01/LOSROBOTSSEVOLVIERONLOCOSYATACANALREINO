...
namespace ProyectoSDL2.Game.States
{
    public class MenuState : IGameState
    {
        ...
        public void Render()
        {
            ...
            Engine.Engine.DrawText(linea1, (screenW - Engine.Engine.TextWidth(linea1, _fontTitulo)) / 2, 200, 255, 220,  50, _fontTitulo);
            Engine.Engine.DrawText(linea2, (screenW - Engine.Engine.TextWidth(linea2, _fontTitulo)) / 2, 280, 255, 220,  50, _fontTitulo);
            Engine.Engine.DrawText(linea3, (screenW - Engine.Engine.TextWidth(linea3, _fontSub))    / 2, 600, 200, 200, 200, _fontSub);
            Engine.Engine.DrawText("Paradigmas de Programacion 2026",                                    280, 700, 0, 0, 0, _fontSub);
            Engine.Engine.Show();
        }
